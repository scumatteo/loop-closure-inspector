...
Example with the sequence 08 of the KITTI dataset. In this case the camera returns more times to the same places, but it moves in a different direction. So, no loop closure is detected.
